 ...
 *   vault.lock();
 *
 * Recovery: there is intentionally no recovery code mechanism. This is
 * a browser-local model; a forgotten passphrase loses the secrets. Add
 * a passkey wrap (`addPasskeyWrap`) for an alternative unlock path.
 */

/**
 * clawser-silent-catch.mjs — debug-gated structured logger for the
 ...
 *
 * Standalone module (no other clawser-* imports) so any file can pull
 * it in without dragging in state.
 */
